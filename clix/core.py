...
import click.types
import click.utils
from clix.completion import completion_init
...
def _clix_param_shell_complete(
...
def _clix_param_setup_autocompletion_compat(
...
def _get_default_string(
    obj: Union["ClixArgument", "ClixOption"],
    *,
    ctx: click.Context,
    ...
    elif isinstance(obj, ClixOption) and obj.is_bool_flag and obj.secondary_opts:
        # For boolean flags that have distinct True/False opts,
        # use the opt without prefix instead of the value.
        # Clix override, original commented
...
def _extract_default_help_str(
    obj: Union["ClixArgument", "ClixOption"], *, ctx: click.Context
...
def _main(
    ...
    **extra: Any,
    ...
    # Clix override, duplicated from click.main() to handle custom rich exceptions
...
class ClixArgument(click.core.Argument):
    def __init__(
        self,
        *,
        # Parameter
    ...
    def get_help_record(self, ctx: click.Context) -> Optional[Tuple[str, str]]:
        ...
        if self.show_envvar:
            envvar = self.envvar
            # allow_from_autoenv is currently not supported in Clix for CLI Arguments
    ...
    def shell_complete(
        ...
        return _clix_param_shell_complete(self, ctx=ctx, incomplete=incomplete)


class ClixOption(click.core.Option):
    def __init__(
        self,
        *,
        # Parameter
    ...
    def get_help_record(self, ctx: click.Context) -> Optional[Tuple[str, str]]:
        ...
        # flags with only names for False values as it's currently supported by Clix
        # Ref: https://clix.khulnasoft.com/tutorial/parameter-types/bool/#only-names-for-false
        if self.hidden:
            return None
...
def _clix_main_shell_completion(
...
class ClixCommand(click.core.Command):
    def __init__(
        self,
        name: Optional[str],
        *,
    ...
    def format_options(
        ...
        _clix_format_options(self, ctx=ctx, formatter=formatter)
...
class ClixGroup(click.core.Group):
    def __init__(
        self,
        *,
