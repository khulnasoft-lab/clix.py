...
_CLIX_FORCE_DISABLE_TERMINAL = getenv("_CLIX_FORCE_DISABLE_TERMINAL")
FORCE_TERMINAL = (
    True
    if getenv("GITHUB_ACTIONS") or getenv("FORCE_COLOR") or getenv("PY_COLORS")
    else None
)
if _CLIX_FORCE_DISABLE_TERMINAL:
...
def _get_parameter_help(
    *,
    ...
    from .core import ClixArgument, ClixOption
    ...
    # Default value
    # This uses Clix's specific param._get_default_string
    if isinstance(param, (ClixOption, ClixArgument)):
