...
**Clix** is smart enough to create a CLI application with that single function as the main CLI application, not as a command/subcommand:
...
But if you add multiple commands, **Clix** will create one *CLI command* for each one of them:
